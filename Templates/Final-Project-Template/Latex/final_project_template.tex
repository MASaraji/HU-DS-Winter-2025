...
\begin{document}
	...
	توضیحات: [در این بخش، ساختار کلی پروژه خود را به‌صورت یک نمای درختی \lr{(Tree Structure) } ارائه دهید. این ساختار باید شامل تمامی فولدرها، کلاس‌ها، فایل‌های داده‌ای و سایر فایل‌های مرتبط باشد. لطفاً برای هر فایل، نوع \lr{(Type)} و نام کامل آن را نیز مشخص کنید. در صورت امکان، تصویری از این ساختار به همراه مسیرها \lr{(Paths) } و چیدمان فایل‌ها نیز ضمیمه نمایید تا نمای کلی پروژه به‌صورت بصری قابل مشاهده باشد.  ]
	\subsection{کلاس ها}
	توضیحات: [ 
در این بخش، نمودار کلاس \lr{(Class Diagram)} نرم‌افزار خود را ارائه دهید. این نمودار باید شامل کلیهٔ کلاس‌های تعریف‌شده در سیستم، روابط بین آن‌ها (مانند ارث‌بری، وابستگی یا پیاده‌سازی رابط‌ها)، متدها و ویژگی‌های اصلی هر کلاس باشد. لطفاً ارتباطات منطقی بین کلاس‌ها را به‌گونه‌ای نمایش دهید که معماری کلی سیستم به‌وضوح قابل درک باشد.
